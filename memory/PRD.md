...
#### 1. إعادة تصميم صفحة POS ✅ (UPDATED - Feb 13, 2026)
- **تغيير رئيسي**: إدماج صفحة POS داخل Layout الرئيسي للتطبيق
- تصميم جديد بثلاثة أعمدة مع Grid Layout:
  - الشريط الأيسر (col-span-2): قائمة المهام مع اختصارات لوحة المفاتيح (Ctrl+0-9)
  - المنطقة الوسطى (col-span-8): جدول المنتجات المضافة للبيع
  - الشريط الأيمن (col-span-2): 20 زر اختصار للمنتجات
- العنوان يظهر "نقطة البيع - NT Commerce" (بدلاً من Lynx)
- تصميم متسق مع باقي صفحات التطبيق (light theme)
- القائمة الجانبية الرئيسية للبرنامج تظهر عند فتح الصفحة
- عرض كود البيع والإجمالي في الأعلى
- تحذير لفتح حصة جديدة قبل البيع بتصميم Card مميز
- أزرار (تأكيد البيع، إلغاء) مع اختصارات لوحة المفاتيح
